...
export PATH=$PATH:/home/etern1ty/.local/bin
...
__conda_setup="$('/home/etern1ty/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/etern1ty/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/home/etern1ty/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/home/etern1ty/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/home/etern1ty/miniforge3/etc/profile.d/mamba.sh" ]; then
